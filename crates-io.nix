...
# cookie-factory-0.2.4
  ...
  crates.cookie_factory."0.2.4" = deps: { features?(features_.cookie_factory."0.2.4" deps {}) }: buildRustCrate {
    ...
    sha256 = "04g7194ar1gc3snldl4c0liqq4425578llpykv2ip9vkganxavy3";
  };
  features_.cookie_factory."0.2.4" = deps: f: updateFeatures f (rec {
    cookie_factory."0.2.4".default = (f.cookie_factory."0.2.4".default or true);
  }) [];
...
# dns-parser-0.8.0
  ...
  crates.dns_parser."0.8.0" = deps: { features?(features_.dns_parser."0.8.0" deps {}) }: buildRustCrate {
    crateName = "dns-parser";
    version = "0.8.0";
    description = "    Pure-rust DNS protocol parser library. This does not support network, only\n    raw protocol parser.\n";
    authors = [ "Paul Colomiets <paul@colomiets.name>" ];
    sha256 = "1zwxdsnmwsnhf06il6cd3v19nrqfzhbfal6dgvngc9l875m0x5mh";
    dependencies = mapFeatures features ([
      (crates."byteorder"."${deps."dns_parser"."0.8.0"."byteorder"}" deps)
      (crates."quick_error"."${deps."dns_parser"."0.8.0"."quick_error"}" deps)
    ]);
    features = mkFeatures (features."dns_parser"."0.8.0" or {});
  };
  features_.dns_parser."0.8.0" = deps: f: updateFeatures f (rec {
    byteorder."${deps.dns_parser."0.8.0".byteorder}".default = true;
    dns_parser = fold recursiveUpdate {} [
      { "0.8.0"."serde" =
        (f.dns_parser."0.8.0"."serde" or false) ||
        (f.dns_parser."0.8.0".with-serde or false) ||
        (dns_parser."0.8.0"."with-serde" or false); }
      { "0.8.0"."serde_derive" =
        (f.dns_parser."0.8.0"."serde_derive" or false) ||
        (f.dns_parser."0.8.0".with-serde or false) ||
        (dns_parser."0.8.0"."with-serde" or false); }
      { "0.8.0".default = (f.dns_parser."0.8.0".default or true); }
    ];
    quick_error."${deps.dns_parser."0.8.0".quick_error}".default = true;
  }) [
    (features_.byteorder."${deps."dns_parser"."0.8.0"."byteorder"}" deps)
    (features_.quick_error."${deps."dns_parser"."0.8.0"."quick_error"}" deps)
  ];
...
# hwaddr-0.1.5
  ...
  crates.hwaddr."0.1.5" = deps: { features?(features_.hwaddr."0.1.5" deps {}) }: buildRustCrate {
    crateName = "hwaddr";
    version = "0.1.5";
    description = "MAC address handling.";
    authors = [ "meh. <meh@schizofreni.co>" ];
    sha256 = "04b9wmzkhw50wb77c5yi82n7zr5vsb143ql07mhb2885xqhs7agb";
    dependencies = mapFeatures features ([
      (crates."phf"."${deps."hwaddr"."0.1.5"."phf"}" deps)
    ]);

    buildDependencies = mapFeatures features ([
      (crates."phf_codegen"."${deps."hwaddr"."0.1.5"."phf_codegen"}" deps)
      (crates."regex"."${deps."hwaddr"."0.1.5"."regex"}" deps)
      (crates."reqwest"."${deps."hwaddr"."0.1.5"."reqwest"}" deps)
      (crates."url"."${deps."hwaddr"."0.1.5"."url"}" deps)
    ]);
    features = mkFeatures (features."hwaddr"."0.1.5" or {});
  };
  features_.hwaddr."0.1.5" = deps: f: updateFeatures f (rec {
    hwaddr."0.1.5".default = (f.hwaddr."0.1.5".default or true);
    phf."${deps.hwaddr."0.1.5".phf}".default = true;
    phf_codegen."${deps.hwaddr."0.1.5".phf_codegen}".default = true;
    regex."${deps.hwaddr."0.1.5".regex}".default = true;
    reqwest."${deps.hwaddr."0.1.5".reqwest}".default = true;
    url."${deps.hwaddr."0.1.5".url}".default = true;
  }) [
    (features_.phf."${deps."hwaddr"."0.1.5"."phf"}" deps)
    (features_.phf_codegen."${deps."hwaddr"."0.1.5"."phf_codegen"}" deps)
    (features_.regex."${deps."hwaddr"."0.1.5"."regex"}" deps)
    (features_.reqwest."${deps."hwaddr"."0.1.5"."reqwest"}" deps)
    (features_.url."${deps."hwaddr"."0.1.5"."url"}" deps)
  ];
...
# lexical-core-0.4.2
  ...
  crates.lexical_core."0.4.2" = deps: { features?(features_.lexical_core."0.4.2" deps {}) }: buildRustCrate {
    crateName = "lexical-core";
    version = "0.4.2";
    description = "Lexical, to- and from-string conversion routines.";
    authors = [ "Alex Huszagh <ahuszagh@gmail.com>" ];
    sha256 = "020wxp88xprlkyz19fbg9s4vfa7kkczyx971n0xjrlq8zy3zji92";
    type = [ "lib" "staticlib" "cdylib" ];
    build = "build.rs";
    dependencies = mapFeatures features ([
      (crates."cfg_if"."${deps."lexical_core"."0.4.2"."cfg_if"}" deps)
      (crates."static_assertions"."${deps."lexical_core"."0.4.2"."static_assertions"}" deps)
    ]
      ++ (if features.lexical_core."0.4.2".ryu or false then [ (crates.ryu."${deps."lexical_core"."0.4.2".ryu}" deps) ] else [])
      ++ (if features.lexical_core."0.4.2".stackvector or false then [ (crates.stackvector."${deps."lexical_core"."0.4.2".stackvector}" deps) ] else []));

    buildDependencies = mapFeatures features ([
      (crates."rustc_version"."${deps."lexical_core"."0.4.2"."rustc_version"}" deps)
    ]);
    features = mkFeatures (features."lexical_core"."0.4.2" or {});
  };
  features_.lexical_core."0.4.2" = deps: f: updateFeatures f (rec {
    cfg_if."${deps.lexical_core."0.4.2".cfg_if}".default = true;
    lexical_core = fold recursiveUpdate {} [
      { "0.4.2"."correct" =
        (f.lexical_core."0.4.2"."correct" or false) ||
        (f.lexical_core."0.4.2".default or false) ||
        (lexical_core."0.4.2"."default" or false); }
      { "0.4.2"."dtoa" =
        (f.lexical_core."0.4.2"."dtoa" or false) ||
        (f.lexical_core."0.4.2".grisu3 or false) ||
        (lexical_core."0.4.2"."grisu3" or false); }
      { "0.4.2"."ryu" =
        (f.lexical_core."0.4.2"."ryu" or false) ||
        (f.lexical_core."0.4.2".default or false) ||
        (lexical_core."0.4.2"."default" or false); }
      { "0.4.2"."stackvector" =
        (f.lexical_core."0.4.2"."stackvector" or false) ||
        (f.lexical_core."0.4.2".correct or false) ||
        (lexical_core."0.4.2"."correct" or false); }
      { "0.4.2"."std" =
        (f.lexical_core."0.4.2"."std" or false) ||
        (f.lexical_core."0.4.2".default or false) ||
        (lexical_core."0.4.2"."default" or false); }
      { "0.4.2"."table" =
        (f.lexical_core."0.4.2"."table" or false) ||
        (f.lexical_core."0.4.2".correct or false) ||
        (lexical_core."0.4.2"."correct" or false); }
      { "0.4.2".default = (f.lexical_core."0.4.2".default or true); }
    ];
    rustc_version."${deps.lexical_core."0.4.2".rustc_version}".default = true;
    ryu."${deps.lexical_core."0.4.2".ryu}".default = true;
    stackvector."${deps.lexical_core."0.4.2".stackvector}".default = true;
    static_assertions."${deps.lexical_core."0.4.2".static_assertions}".default = true;
  }) [
    (features_.cfg_if."${deps."lexical_core"."0.4.2"."cfg_if"}" deps)
    (features_.ryu."${deps."lexical_core"."0.4.2"."ryu"}" deps)
    (features_.stackvector."${deps."lexical_core"."0.4.2"."stackvector"}" deps)
    (features_.static_assertions."${deps."lexical_core"."0.4.2"."static_assertions"}" deps)
    (features_.rustc_version."${deps."lexical_core"."0.4.2"."rustc_version"}" deps)
  ];
...
# nom-5.0.0
  ...
  crates.nom."5.0.0" = deps: { features?(features_.nom."5.0.0" deps {}) }: buildRustCrate {
    crateName = "nom";
    version = "5.0.0";
    description = "A byte-oriented, zero-copy, parser combinators library";
    authors = [ "contact@geoffroycouprie.com" ];
    edition = "2018";
    sha256 = "094v9slvx8d54cgmcdz6fhmkz5j6rb7rymb4caxhmznrdnrv047p";
    dependencies = mapFeatures features ([
      (crates."memchr"."${deps."nom"."5.0.0"."memchr"}" deps)
    ]
      ++ (if features.nom."5.0.0".lexical-core or false then [ (crates.lexical_core."${deps."nom"."5.0.0".lexical_core}" deps) ] else []));

    buildDependencies = mapFeatures features ([
      (crates."version_check"."${deps."nom"."5.0.0"."version_check"}" deps)
    ]);
    features = mkFeatures (features."nom"."5.0.0" or {});
  };
  features_.nom."5.0.0" = deps: f: updateFeatures f (rec {
    lexical_core."${deps.nom."5.0.0".lexical_core}".default = true;
    memchr = fold recursiveUpdate {} [
      { "${deps.nom."5.0.0".memchr}"."use_std" =
        (f.memchr."${deps.nom."5.0.0".memchr}"."use_std" or false) ||
        (nom."5.0.0"."std" or false) ||
        (f."nom"."5.0.0"."std" or false); }
      { "${deps.nom."5.0.0".memchr}".default = (f.memchr."${deps.nom."5.0.0".memchr}".default or false); }
    ];
    nom = fold recursiveUpdate {} [
      { "5.0.0"."alloc" =
        (f.nom."5.0.0"."alloc" or false) ||
        (f.nom."5.0.0".std or false) ||
        (nom."5.0.0"."std" or false); }
      { "5.0.0"."lazy_static" =
        (f.nom."5.0.0"."lazy_static" or false) ||
        (f.nom."5.0.0".regexp_macros or false) ||
        (nom."5.0.0"."regexp_macros" or false); }
      { "5.0.0"."lexical" =
        (f.nom."5.0.0"."lexical" or false) ||
        (f.nom."5.0.0".default or false) ||
        (nom."5.0.0"."default" or false); }
      { "5.0.0"."lexical-core" =
        (f.nom."5.0.0"."lexical-core" or false) ||
        (f.nom."5.0.0".lexical or false) ||
        (nom."5.0.0"."lexical" or false); }
      { "5.0.0"."regex" =
        (f.nom."5.0.0"."regex" or false) ||
        (f.nom."5.0.0".regexp or false) ||
        (nom."5.0.0"."regexp" or false); }
      { "5.0.0"."regexp" =
        (f.nom."5.0.0"."regexp" or false) ||
        (f.nom."5.0.0".regexp_macros or false) ||
        (nom."5.0.0"."regexp_macros" or false); }
      { "5.0.0"."std" =
        ...
        (f.nom."5.0.0".default or false) ||
        (nom."5.0.0"."default" or false); }
      { "5.0.0".default = (f.nom."5.0.0".default or true); }
    ];
    version_check."${deps.nom."5.0.0".version_check}".default = true;
  }) [
    (features_.lexical_core."${deps."nom"."5.0.0"."lexical_core"}" deps)
    (features_.memchr."${deps."nom"."5.0.0"."memchr"}" deps)
    (features_.version_check."${deps."nom"."5.0.0"."version_check"}" deps)
  ];
...
# pcap-0.7.0
  ...
  crates.pcap."0.7.0" = deps: { features?(features_.pcap."0.7.0" deps {}) }: buildRustCrate {
    crateName = "pcap";
    version = "0.7.0";
    description = "A packet capture API around pcap/wpcap";
    authors = [ "Sean Bowe <ewillbefull@gmail.com>" ];
    sha256 = "030110w1g9jz01k6nchxm1rjaym8va3wc8a1sb98p20kb306zfji";
    build = "build.rs";
    dependencies = mapFeatures features ([
      (crates."libc"."${deps."pcap"."0.7.0"."libc"}" deps)
    ]);
    features = mkFeatures (features."pcap"."0.7.0" or {});
  };
  features_.pcap."0.7.0" = deps: f: updateFeatures f (rec {
    libc."${deps.pcap."0.7.0".libc}".default = true;
    pcap = fold recursiveUpdate {} [
      { "0.7.0"."futures" =
        (f.pcap."0.7.0"."futures" or false) ||
        (f.pcap."0.7.0".tokio or false) ||
        (pcap."0.7.0"."tokio" or false); }
      { "0.7.0"."mio" =
        (f.pcap."0.7.0"."mio" or false) ||
        (f.pcap."0.7.0".tokio or false) ||
        (pcap."0.7.0"."tokio" or false); }
      { "0.7.0"."pcap-fopen-offline-precision" =
        (f.pcap."0.7.0"."pcap-fopen-offline-precision" or false) ||
        (f.pcap."0.7.0".full or false) ||
        (pcap."0.7.0"."full" or false); }
      { "0.7.0"."pcap-savefile-append" =
        (f.pcap."0.7.0"."pcap-savefile-append" or false) ||
        (f.pcap."0.7.0".full or false) ||
        (pcap."0.7.0"."full" or false); }
      { "0.7.0"."tokio" =
        (f.pcap."0.7.0"."tokio" or false) ||
        ...
        (pcap."0.7.0"."full" or false); }
      { "0.7.0"."tokio-core" =
        (f.pcap."0.7.0"."tokio-core" or false) ||
        (f.pcap."0.7.0".tokio or false) ||
        (pcap."0.7.0"."tokio" or false); }
      { "0.7.0".default = (f.pcap."0.7.0".default or true); }
    ];
  }) [
    (features_.libc."${deps."pcap"."0.7.0"."libc"}" deps)
  ];
...
# pktparse-0.4.0
  ...
  crates.pktparse."0.4.0" = deps: { features?(features_.pktparse."0.4.0" deps {}) }: buildRustCrate {
    crateName = "pktparse";
    version = "0.4.0";
    description = "Collection of packet parsers";
    authors = [ "Nathan Moos" "Xavier Bestel" ];
    edition = "2018";
    sha256 = "1y3bqmyjpj9a47jm295y1542ww3imc42nhankyp7vb0z760wamwg";
    dependencies = mapFeatures features ([
      (crates."nom"."${deps."pktparse"."0.4.0"."nom"}" deps)
    ]
      ++ (if features.pktparse."0.4.0".serde or false then [ (crates.serde."${deps."pktparse"."0.4.0".serde}" deps) ] else [])
      ++ (if features.pktparse."0.4.0".serde_derive or false then [ (crates.serde_derive."${deps."pktparse"."0.4.0".serde_derive}" deps) ] else []));
    features = mkFeatures (features."pktparse"."0.4.0" or {});
  };
  features_.pktparse."0.4.0" = deps: f: updateFeatures f (rec {
    nom."${deps.pktparse."0.4.0".nom}".default = true;
    pktparse = fold recursiveUpdate {} [
      { "0.4.0"."serde" =
        (f.pktparse."0.4.0"."serde" or false) ||
        (f.pktparse."0.4.0".derive or false) ||
        (pktparse."0.4.0"."derive" or false); }
      { "0.4.0"."serde_derive" =
        (f.pktparse."0.4.0"."serde_derive" or false) ||
        (f.pktparse."0.4.0".derive or false) ||
        (pktparse."0.4.0"."derive" or false); }
      { "0.4.0".default = (f.pktparse."0.4.0".default or true); }
    ];
    serde."${deps.pktparse."0.4.0".serde}".default = true;
    serde_derive."${deps.pktparse."0.4.0".serde_derive}".default = true;
  }) [
    (features_.nom."${deps."pktparse"."0.4.0"."nom"}" deps)
    (features_.serde."${deps."pktparse"."0.4.0"."serde"}" deps)
    (features_.serde_derive."${deps."pktparse"."0.4.0"."serde_derive"}" deps)
  ];
...
# rusticata-macros-1.1.0
  ...
  crates.rusticata_macros."1.1.0" = deps: { features?(features_.rusticata_macros."1.1.0" deps {}) }: buildRustCrate {
    crateName = "rusticata-macros";
    version = "1.1.0";
    description = "Helper macros for Rusticata";
    authors = [ "Pierre Chifflier <chifflier@wzdftpd.net>" ];
    sha256 = "0a0pi5h4zmv5h8n9wzwrv3030gbk4icdxin9rbgwhyjkh8j6h1z1";
    dependencies = mapFeatures features ([
      (crates."nom"."${deps."rusticata_macros"."1.1.0"."nom"}" deps)
    ]);
  };
  features_.rusticata_macros."1.1.0" = deps: f: updateFeatures f (rec {
    nom."${deps.rusticata_macros."1.1.0".nom}".default = true;
    rusticata_macros."1.1.0".default = (f.rusticata_macros."1.1.0".default or true);
  }) [
    (features_.nom."${deps."rusticata_macros"."1.1.0"."nom"}" deps)
  ];
...
# stackvector-1.0.6
  ...
  crates.stackvector."1.0.6" = deps: { features?(features_.stackvector."1.0.6" deps {}) }: buildRustCrate {
    ...
    sha256 = "1k75pmam96wy53jbnb59lqd7gw17nnizbhgrkp8274p6j2d4a0ci";
    build = "build.rs";
    dependencies = mapFeatures features ([
      (crates."unreachable"."${deps."stackvector"."1.0.6"."unreachable"}" deps)
    ]);

    buildDependencies = mapFeatures features ([
      (crates."rustc_version"."${deps."stackvector"."1.0.6"."rustc_version"}" deps)
    ]);
    features = mkFeatures (features."stackvector"."1.0.6" or {});
  };
  features_.stackvector."1.0.6" = deps: f: updateFeatures f (rec {
    rustc_version."${deps.stackvector."1.0.6".rustc_version}".default = true;
    stackvector = fold recursiveUpdate {} [
      { "1.0.6"."std" =
        (f.stackvector."1.0.6"."std" or false) ||
        (f.stackvector."1.0.6".default or false) ||
        (stackvector."1.0.6"."default" or false); }
      { "1.0.6".default = (f.stackvector."1.0.6".default or true); }
    ];
    unreachable."${deps.stackvector."1.0.6".unreachable}".default = true;
  }) [
    (features_.unreachable."${deps."stackvector"."1.0.6"."unreachable"}" deps)
    (features_.rustc_version."${deps."stackvector"."1.0.6"."rustc_version"}" deps)
  ];
...
# static_assertions-0.2.5
  ...
  crates.static_assertions."0.2.5" = deps: { features?(features_.static_assertions."0.2.5" deps {}) }: buildRustCrate {
    crateName = "static_assertions";
    version = "0.2.5";
    description = "Compile-time assertions to ensure that invariants are met.";
    authors = [ "Nikolai Vazquez" ];
    sha256 = "1yhbpn91fm7mgdrgbh3kvz505a48wzvmwi9pppj344hlrajp6gjw";
  };
  features_.static_assertions."0.2.5" = deps: f: updateFeatures f (rec {
    static_assertions."0.2.5".default = (f.static_assertions."0.2.5".default or true);
  }) [];
...
# tls-parser-0.7.1
  ...
  crates.tls_parser."0.7.1" = deps: { features?(features_.tls_parser."0.7.1" deps {}) }: buildRustCrate {
    crateName = "tls-parser";
    version = "0.7.1";
    description = "Parser for the TLS protocol";
    authors = [ "Pierre Chifflier <chifflier@wzdftpd.net>" ];
    sha256 = "0ry7bd7xd14pwr9n1s1r8fq4kq5ggdqyylf8h7s4dl0lpxdm6hrh";
    libName = "tls_parser";
    build = "build.rs";
    dependencies = mapFeatures features ([
      (crates."cookie_factory"."${deps."tls_parser"."0.7.1"."cookie_factory"}" deps)
      (crates."enum_primitive"."${deps."tls_parser"."0.7.1"."enum_primitive"}" deps)
      (crates."nom"."${deps."tls_parser"."0.7.1"."nom"}" deps)
      (crates."phf"."${deps."tls_parser"."0.7.1"."phf"}" deps)
      (crates."rusticata_macros"."${deps."tls_parser"."0.7.1"."rusticata_macros"}" deps)
    ]);

    buildDependencies = mapFeatures features ([
      (crates."phf_codegen"."${deps."tls_parser"."0.7.1"."phf_codegen"}" deps)
    ]);
    features = mkFeatures (features."tls_parser"."0.7.1" or {});
  };
  features_.tls_parser."0.7.1" = deps: f: updateFeatures f (rec {
    cookie_factory."${deps.tls_parser."0.7.1".cookie_factory}".default = true;
    enum_primitive."${deps.tls_parser."0.7.1".enum_primitive}".default = true;
    nom = fold recursiveUpdate {} [
      { "${deps.tls_parser."0.7.1".nom}"."verbose-errors" = true; }
      { "${deps.tls_parser."0.7.1".nom}".default = true; }
    ];
    phf."${deps.tls_parser."0.7.1".phf}".default = true;
    phf_codegen."${deps.tls_parser."0.7.1".phf_codegen}".default = true;
    rusticata_macros."${deps.tls_parser."0.7.1".rusticata_macros}".default = true;
    tls_parser."0.7.1".default = (f.tls_parser."0.7.1".default or true);
  }) [
    (features_.cookie_factory."${deps."tls_parser"."0.7.1"."cookie_factory"}" deps)
    (features_.enum_primitive."${deps."tls_parser"."0.7.1"."enum_primitive"}" deps)
    (features_.nom."${deps."tls_parser"."0.7.1"."nom"}" deps)
    (features_.phf."${deps."tls_parser"."0.7.1"."phf"}" deps)
    (features_.rusticata_macros."${deps."tls_parser"."0.7.1"."rusticata_macros"}" deps)
    (features_.phf_codegen."${deps."tls_parser"."0.7.1"."phf_codegen"}" deps)
  ];
