...
# snoopy-0.2.0
    ...
    crates.snoopy."0.2.0" = deps: { features?(features_.snoopy."0.2.0" deps {}) }: buildRustCrate {
      crateName = "snoopy";
      version = "0.2.0";
      ...
      dependencies = mapFeatures features ([
        (cratesIO.crates."clap"."${deps."snoopy"."0.2.0"."clap"}" deps)
        (cratesIO.crates."dns_parser"."${deps."snoopy"."0.2.0"."dns_parser"}" deps)
        (cratesIO.crates."httparse"."${deps."snoopy"."0.2.0"."httparse"}" deps)
        (cratesIO.crates."hwaddr"."${deps."snoopy"."0.2.0"."hwaddr"}" deps)
        (cratesIO.crates."nom"."${deps."snoopy"."0.2.0"."nom"}" deps)
        (cratesIO.crates."num_cpus"."${deps."snoopy"."0.2.0"."num_cpus"}" deps)
        (cratesIO.crates."pcap"."${deps."snoopy"."0.2.0"."pcap"}" deps)
        (cratesIO.crates."pktparse"."${deps."snoopy"."0.2.0"."pktparse"}" deps)
        (cratesIO.crates."serde"."${deps."snoopy"."0.2.0"."serde"}" deps)
        (cratesIO.crates."serde_json"."${deps."snoopy"."0.2.0"."serde_json"}" deps)
        (cratesIO.crates."threadpool"."${deps."snoopy"."0.2.0"."threadpool"}" deps)
        (cratesIO.crates."tls_parser"."${deps."snoopy"."0.2.0"."tls_parser"}" deps)
      ]);
    };
    features_.snoopy."0.2.0" = deps: f: updateFeatures f (rec {
      clap."${deps.snoopy."0.2.0".clap}".default = true;
      dns_parser."${deps.snoopy."0.2.0".dns_parser}".default = true;
      httparse."${deps.snoopy."0.2.0".httparse}".default = true;
      hwaddr."${deps.snoopy."0.2.0".hwaddr}".default = true;
      nom."${deps.snoopy."0.2.0".nom}".default = true;
      num_cpus."${deps.snoopy."0.2.0".num_cpus}".default = true;
      pcap."${deps.snoopy."0.2.0".pcap}".default = true;
      pktparse = fold recursiveUpdate {} [
        { "${deps.snoopy."0.2.0".pktparse}"."derive" = true; }
        { "${deps.snoopy."0.2.0".pktparse}".default = true; }
      ];
      serde."${deps.snoopy."0.2.0".serde}".default = true;
      serde_json."${deps.snoopy."0.2.0".serde_json}".default = true;
      snoopy."0.2.0".default = (f.snoopy."0.2.0".default or true);
      threadpool."${deps.snoopy."0.2.0".threadpool}".default = true;
      tls_parser."${deps.snoopy."0.2.0".tls_parser}".default = true;
    }) [
      (cratesIO.features_.clap."${deps."snoopy"."0.2.0"."clap"}" deps)
      (cratesIO.features_.dns_parser."${deps."snoopy"."0.2.0"."dns_parser"}" deps)
      (cratesIO.features_.httparse."${deps."snoopy"."0.2.0"."httparse"}" deps)
      (cratesIO.features_.hwaddr."${deps."snoopy"."0.2.0"."hwaddr"}" deps)
      (cratesIO.features_.nom."${deps."snoopy"."0.2.0"."nom"}" deps)
      (cratesIO.features_.num_cpus."${deps."snoopy"."0.2.0"."num_cpus"}" deps)
      (cratesIO.features_.pcap."${deps."snoopy"."0.2.0"."pcap"}" deps)
      (cratesIO.features_.pktparse."${deps."snoopy"."0.2.0"."pktparse"}" deps)
      (cratesIO.features_.serde."${deps."snoopy"."0.2.0"."serde"}" deps)
      (cratesIO.features_.serde_json."${deps."snoopy"."0.2.0"."serde_json"}" deps)
      (cratesIO.features_.threadpool."${deps."snoopy"."0.2.0"."threadpool"}" deps)
      (cratesIO.features_.tls_parser."${deps."snoopy"."0.2.0"."tls_parser"}" deps)
    ];
...
# end
  ...
  snoopy = crates.crates.snoopy."0.2.0" deps;
  __all = [ (snoopy {}) ];
  deps.adler32."1.0.3" = {};
  ...
  deps.stackvector."1.0.6" = {
    unreachable = "1.0.0";
    rustc_version = "0.2.3";
  };
  deps.static_assertions."0.2.5" = {};
  deps.string."0.2.1" = {
    bytes = "0.4.12";
  };
  deps.strsim."0.8.0" = {};
  ...
  deps.tls_parser."0.7.1" = {
    cookie_factory = "0.2.4";
    enum_primitive = "0.1.1";
    nom = "4.2.3";
    phf = "0.7.24";
    rusticata_macros = "1.1.0";
    phf_codegen = "0.7.24";
  };
  deps.tokio."0.1.22" = {
    bytes = "0.4.12";
